        ...
        [
            ...
            function (callback) {
                ...
                temp.mkdir('nog-', function(err, result){
                    ...
                    log.verbose('\t', colors.gray(site_serve_directory), '\n');
            ...
            //build the site...
            function (callback) {
                build.build(false, process.cwd(), site_serve_directory, callback);
            },
            ...
            function (callback) {
                ...
                app.listen(options.port, function (err) {
                    server_info = {
                        url: sprintf('http://localhost:%s/%s', options.port, cfg.prefix)
                    };
                    if (! err){
